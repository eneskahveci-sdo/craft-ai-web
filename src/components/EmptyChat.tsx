...
export function EmptyChat({ hasModel, hasRepo, onAddModel, onPrompt }: EmptyChatProps) {
  return (
    <div className="flex flex-col items-center justify-center h-full px-6 py-10 select-none">
      <div className="w-14 h-14 rounded-full bg-bgsoft border border-brand/25 grid place-items-center mb-5 shadow-lg shadow-brand/10 text-3xl text-brand select-none">
        ✦
      </div>

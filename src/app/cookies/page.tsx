...
export const metadata: Metadata = {
  title: "Çerez Politikası — craft.ai",
  description:
    "craft.ai'nin hangi çerezleri kullandığı ve bunları nasıl yönetebileceğinize dair bilgiler.",
};
      ...
      <main className="max-w-3xl mx-auto px-6 py-14 flex-1 w-full">
        ...
        <div>
          <Section title="1. Çerez Nedir?">
            ...
            <p className="mt-2">
              craft.ai, kullanıcı deneyimini bozmayacak şekilde{" "}
          ...
          <Section title="3. localStorage ile Saklanan Veriler">
            <p>
              Çerez olmamakla birlikte, craft.ai tarayıcınızın{" "}
          ...
          <Section title="4. Üçüncü Taraf Çerezleri">
            <p>
              craft.ai herhangi bir üçüncü taraf reklam veya analitik
          ...
          <Section title="6. localStorage Temizleme">
            <p>
              ...
              <strong>Yerel Depolama</strong> bölümünden craft.ai verilerini
